...
class MockoonAPI:
  def __init__(self, data_file: str, hostname: str | None = None, port: int | None = None, pname: str | None = None, *, use_docker: bool = False, repair: bool | None = False):
    self.server = MockoonServer(data_file, hostname, port, pname, use_docker=use_docker, repair=repair)
  ...
  def assert_has_calls(self, requests: list[Request], *, any_order=False):
    self.assertions.assert_has_calls(requests, any_order=False)
  ...
  def assert_has_calls_with_properties(self, calls, *, any_order=False):
    self.assertions.assert_has_calls_with_properties(calls, any_order=False)
